...
export const BETA_HERO_NOTICE =
  "Nitor is in public beta. Every feature is unlocked and free to use, and I’m building it in the open — expect rough edges, occasional bugs, and changes as I go. Pricing will be introduced when Nitor leaves beta.";
...
export const BETA_SIGNUP_NOTICE =
  "Free during beta. No card required. Beta software: your data is safe, but features may change and bugs are possible — you can export everything from Settings at any time.";
